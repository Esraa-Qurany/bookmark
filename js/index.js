...
function displayLastIndex(){
        ...
        `<tr>
           ...
           <td>
            <button onclick="deleteBookmarker();" class="btn btn-delete"><i class="fa-solid fa-trash-can"></i> Delete</button>
           </td>
        </tr>`;
...
function displayData(){
    ...
    for(i=0 ; i < bookmarkerList.length ; i++){
        ...
        `<tr>
           ...
           <td>
            <button onclick="visitBookmarker('${i}');" class="btn btn-visit"><i class="fa-solid fa-eye"></i> Visit</button>
           </td>
           <td>
...
function visitBookmarker(i){
    var visit = bookmarkerList[i].url
    open(`https://${visit}`)
